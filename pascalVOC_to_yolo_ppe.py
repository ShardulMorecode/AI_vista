...
def convert_voc_to_yolo(voc_dir, yolo_dir, classes_file):
    ...
    # Load class names (PPE only, no "person")
    ...
    for xml_file in os.listdir(voc_dir):
        ...
        with open(yolo_label_path, "w") as yolo_file:
            for obj in root.findall("object"):
                ...
                # Check if class exists in PPE list
...
if __name__ == "__main__":
    ...
    parser.add_argument("input_dir", help="Path to PascalVOC annotation directory")
    parser.add_argument("output_dir", help="Path to save YOLOv8 annotations")
    parser.add_argument("classes_file", help="Path to classes_ppe.txt")
